...
<template>
  <main class="club-page">
    <header class="topbar"><BrandLogo variant="purple" :height="34" to="/" /><nav><el-link @click="router.push('/activities')">活动</el-link><el-link v-if="auth.isAdmin" @click="router.push('/admin')">管理端</el-link></nav></header>
