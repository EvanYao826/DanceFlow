...
<style scoped>
.activities-page { min-height: 100vh; background: linear-gradient(145deg, #fbf7ff 0%, #f6effa 48%, #fff 100%); }.topbar { height: 68px; display: flex; align-items: center; justify-content: space-between; padding: 0 24px; background: #fff; }.topbar nav { display: flex; gap: 22px; }.heading { padding: 56px 24px 40px; max-width: 1120px; margin: auto; }.eyebrow { color: var(--df-primary-700); letter-spacing: 2px; font-size: 12px; }.heading h1 { margin: 10px 0; font-size: 42px; color: var(--df-primary-950); }.heading p:last-child { color: #77717e; }.filter { margin-top: 24px; }.activity-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; max-width: 1120px; min-height: 260px; margin: auto; padding: 0 24px 36px; }.activity-card { cursor: pointer; overflow: hidden; }.cover { height: 120px; display: flex; align-items: flex-end; padding: 16px; background: linear-gradient(135deg, var(--df-primary-800), var(--df-primary-500)); color: #fff; }.card-body { padding: 18px; }.card-meta { color: var(--df-primary-700); font-size: 12px; }.card-body h2 { margin: 10px 0; font-size: 20px; }.card-body p { height: 42px; overflow: hidden; color: #77717e; line-height: 1.5; }.card-footer { display: flex; justify-content: space-between; align-items: center; margin-top: 16px; }.el-pagination { justify-content: center; padding: 20px 0 48px; }
