...
public class StatisticsService {
    ...
    private List<StatisticsTrendVO> trend(String sql, LocalDate start, LocalDate end) { return jdbc.query(sql, (start == null ? LocalDate.now().minusDays(29) : start).atStartOfDay(), (end == null ? LocalDate.now() : end).plusDays(1).atStartOfDay(), (rs, n) -> new StatisticsTrendVO(rs.getString("day"), rs.getLong("value"))); }
